...
export TERRAFORM_PROVIDER_SOURCE ?= dmacvicar/libvirt
export TERRAFORM_PROVIDER_REPO ?= https://github.com/dmacvicar/terraform-provider-libvirt
export TERRAFORM_PROVIDER_VERSION ?= 0.7.6
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-libvirt
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/dmacvicar/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-libvirt_v0.7.6
export TERRAFORM_DOCS_PATH ?= version
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/libvirts/01-delete.yaml.tmpl.
