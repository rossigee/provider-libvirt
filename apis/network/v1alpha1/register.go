...
// Package v1alpha1 contains managed resources for libvirt virtual networks.
package v1alpha1
...
const (
	CRDGroup   = "network.libvirt.crossplane.io"
	CRDVersion = "v1alpha1"
)
...
var (
	...
	NetworkGroupKind        = schema.GroupKind{Group: CRDGroup, Kind: NetworkKind}.String()
